...
class TestSemantixAgentToolInput:
    def test_its_children_class_should_be_able_to_parse_json_string_to_its_instance(
        self,
    ) -> None:
        ...
        semantix_agent_tool_input = sut.query_to_tool_input(
            json.dumps({"input_1": "x", "input_2": {"input_2_1": 0}})
        )
